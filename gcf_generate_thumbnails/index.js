...
exports.generateThumbnail = async (file, context) => {
  ...
  const thumbnailsBucket = storage.bucket('sp24-41200-gj-thumbnails');
  const finalBucket = storage.bucket('sp24-41200-gj-finals');
 ...
 console.log(`content type  : ${gcsFile.ContentType}`);
  ...
  console.log(`delete uploaded file:${gcsFile.name}`);
}